...
all_diagnosis = {
    ...
    'Здоров': {
        ...
        "complaints_text": "нет",
        "examination": {
                        'Передняя риноскопия': ['Носовое дыхание -', 'свободное',
                                                'Носовая перегородка -', 'в срединном положении',
                                                'Слизистая оболочка носа -', 'розовая',
                                                'Носовые раковины -', 'не изменены'],
                        'Фарингоскопия': ['слизистая оболочка глотки -', 'обычной окраски',
                                          'Небные дужки -', 'не гиперемированы',
                                          'В лакунах -', 'содержимого нет'],
                        'Общее состояние': ['удовлетворительное', ],
                        'Отоскопия': ['Отоскопия_AU_наружный слуховой проход свободен',
                                      'AU_барабанная перепонка -',
                                      'AU_нормального цвета, серая, знаки определяются'],
                        'Периферические лимфоузлы': ['не увеличены', 'при пальпации -', 'эластичные',
                                                     'безболезненные', 'не спаяны с окружающей тканью'],
                        },
        "examination_text": "Общее состояние: удовлетворительное, \n"
                            "Передняя риноскопия: Носовое дыхание - свободное, \n"
                            "Носовая перегородка - в срединном положении, \n"
                            "Слизистая оболочка носа - розовая, Носовые раковины - не изменены, \n\n"
                            "Задняя риноскопия: носоглотка - хоаны свободны, \n\n"
                            "Фарингоскопия: слизистая оболочка глотки - обычной окраски, \n"
                            "Небные дужки - не гиперемированы, В лакунах - содержимого нет, \n" 
                            "Отоскопия: AU - наружный слуховой проход свободен, "
                            "барабанная перепонка - нормального цвета, серая, знаки определяются, \n\n" 
                            "Периферические лимфоузлы: не увеличены, при пальпации - эластичные, "
                            "безболезненные, не спаяны с окружающей тканью.",
        "prescription": {"Рекомендации": []},
        "prescription_text": "",
        "diagnosis_text": "На момент осмотра без острой ЛОР патологии"
    },

}

all_data_diagnosis = {
    'diagnosis_ori': (("На момент осмотра без острой ЛОР патологии",),
                      ('Отит', "Серная пробка", "Дисфункция слуховых труб", "AD", "AS", "AU"),
                      ("острый", "средний", "хронический", "катаральный", "гнойный", "экссудативный", "наружный",
                       "диффузный"),
                      ("Синусит", "Гайморит", "Фронтит", "Этмоидит", "клинически", "рентгенологически"),
                      ("острый", "хронический", "в стадии обострения"),
                      ("Ринит", "Риноаденоидит", "Риносинусит", "Фарингит", "Ринофарингит", "Тонзиллит",),
                      ("Гипертрофия аденоидов", "Гипертрофия небных миндалин", "1 степени", "2 степени", "3 степени"),
                      ("Реактивный лимфаденит", "справа", "слева", "двусторонний")
    ...
    "diagnosis_child": (
        "Вид осмотра", 'Врачебно-сестринский патронаж', 'Патронаж', "На приеме здоров", "Годовой эпикриз"),
    "diagnosis": ("Предварительный диагноз", "Здоров",),

    "place": ('на дому', 'в поликлинике'),
    'complaints': ('нет', 'обусловлены основным заболеванием', "_",
                   "насморк", " заложенность носа", "затяжное течение", "беспокойство", "_",
                   "трогает уши", "храп по ночам", "ротовое дыхание",
                   ("температура", '37', '37.5', '38', '38.5', '39', '39.5', '40', '40.5'),
                   ("Боль в", "ухе", "ушах", "области козелка", "справа", "слева", "голове", "лобной области", "горле"),
                   ("кашель", "сухой", "влажный", "приступообразный", "лающий"),
                   ("насморк", "заложенность носа", "слизистые выделения", "гнойные выделения", "затяжное течение"),
                   ),
    ...
    "examination": (
        ...
        ("Передняя риноскопия", "Носовое дыхание -", "свободное", "затруднено", "умерено", "отсутствует", "\n",
         "справа", "слева", "с обеих сторон", "\n",
         "Отделяемое -", "слизистое", "гнойное", "\n",
         "Носовая перегородка -", "в срединном положении", "искривлена", "\n",
         "в хрящевом отделе", "в костном отделе", "влево", "вправо", "\n",
         "Слизистая оболочка носа -", "розовая", "гиперемирована", "набухшая", "имеются полипы", "\n",
         "Носовые раковины -", "не изменены", "гипертрофированы", "отёчны", "гиперемия"),

        ("Задняя риноскопия", "носоглотка -", "хоаны свободны", "хоанальный полип", "\n",
         "гипертрофия задних концов нижних носовых раковин", "\n",
         "аденоиды -", "1-й степени", "2-й степени", "3-й степени"),

        ("Фарингоскопия", "слизистая оболочка глотки -", "обычной окраски", "гиперемирована", "\n",
         "Небные дужки -", "не гиперемированы", "гиперемированы", "\n",
         "В лакунах -", "содержимого нет", "гной", "казеозные пробки"),

        ("Ларингоскопия", "Голос -", "звучный", "хриплый", "\n",
         "Истинные голосовые складки -", "подвижны", "ограничение подвижности", "справа", "слева", "\n",
         "Цвет голосовых складок -", "белесоватые", "гиперемированы"),

        ("Отоскопия", "без патологии", "\n",
         "наружный слуховой проход свободен", "серная пробка удалена", "\n",
         "барабанная перепонка -", "нормального цвета, серая, знаки определяются", "\n",
         "гиперемирована", "серозное содержимое", "гнойное содержимое", "выбухание", "перфорация", "\n",
         "мутная", "втянута", "\n",
         "отит -", "катаральный", "гнойный", "экссудативный", "наружный диффузный"),

        ("Периферические лимфоузлы", "не увеличены", '\n',
         "увеличены", "подчелюстные", "передние шейные", "задние шейные", "\n",
         "околоушные", "затылочные", "надключичные", "подмышечные", '\n',
         "справа", "слева", "с обеих сторон", '\n',
         "при пальпации -", "плотные", "эластичные", "болезненные", "безболезненные", '\n',
         "подвижные", "не спаяны с окружающей тканью"),

        ("Шепотная речь", "1м", "2м", "3м", "4м", "5м", "6м"),

        ("Тимпанометрия", "Тип A", "Тип B", "Тип C", "Тип D", "Тип E", "Тип Ad"),
    ...
    "prescription": (("Рекомендации",
                      ...
                      ("увлажнение помещения 45-55%",),
                      ("полоскать горло", "орошать горло"),
                      ("промывать нос солевыми растворами", "сосудосуживающие капли",),
                      ("Пробиотики - Линекс Форте", "Пробиотики - Пробакто ЛОР"),
                      ("Гимнастика слуховых труб",),
                      ("Наблюдение у участкового педиатра",),
                      ("ЖДАААТЬ ПОКА САМО ПРОЙДЕТ!!!",),
                      ),
    ...
    "drugs": {
        ...
        "ОРИ": (
            ...
            ("Оксиметазолин - капли в нос",
             ...
             "закапывать по 1-2 капли в каждый носовой ход после туалета физраствором", "выписан льготный рецепт",
             "имеется дома"),
        ...
        "Бронхолитики": (
            ...
            ("Флутиказон",
             "Форма", "аэрозоль 50мкг/доза - 120 доз", "аэрозоль 125мкг/доза - 120 доз",
             "аэрозоль 250мкг/доза - 120 доз",
             "Дозировка", "1 доза", "2 дозы", "3 дозы",
             "Кратность", "1 р/сут", "2 р/сут", "3 р/сут",
             "Длительность", "3 дня", "5 дней", "7 дней", "10 дней", "14 дней", "продолжить", "длительно",
             "Способ применения", "выписан рецепт", "выписан льготный рецепт", "имеется дома"),
        ...
        "Глазные капли": (
            ...
            ("Тобрамицин - капли глазные 0.3%",
             ...
             "при наличии гнойного содержимого - промыть конъюнктивальную полость", "выписан льготный рецепт",
             "имеется дома"),
        ...
        "ЖКТ": (
            ...
            ("Симетикон",
             "Форма", "капли для приема внутрь 40мг/мл", "капли для приема внутрь 66.66 мг/мл",
             "капли для приема внутрь 100мг/мл", "капли для приема внутрь 300 мг/мл", "капс 40 мг", "капс 80 мг",
             "капс 120 мг",
...
def paste_examination_cmd_main(root_examination: Toplevel, examination_root: Frame, child_marker=False):
        ...
        def past_examination(past_examination_frame: Frame):
            ...
            if not found_info:
                ...
                for info in found_info:
                    ...
                    past_exam_text.set(
                        f"Время редактирования: {date_time}    Пользователь: {doctor_name}    Статус: {status}")
    ...
    def paste_frame_diagnosis():
        def select_diagnosis():
            ...
            if "Проведена беседа: Безопасность ____" in all_diagnosis.get(selected_diagnosis.get()).get(
                    "epicrisis_add_text", ''):
                ...
                txt_epicrisis_add.insert(1.0, all_diagnosis.get(selected_diagnosis.get()).get("epicrisis_add_text",
                                                                                              '').replace(
                    'Проведена беседа: Безопасность ____', f"Проведена беседа: {random.choice(conversation)}"))
            else:
                txt_epicrisis_add.insert(1.0, all_diagnosis.get(selected_diagnosis.get()).get("epicrisis_add_text", ''))
        ...
        for mark in loc_data[1:]:
            if len(sorted_loc_data[-1]) == 5:
                sorted_loc_data.append([])
            sorted_loc_data[-1].append(mark)

        for mark_group in sorted_loc_data:
            frame = Frame(frame_diagnosis_1)
        ...
        frame_diagnosis.pack(fill='both', expand=True)
    ...
    def my_saved_diagnosis():
        ...
        button_saved_new_diagnosis = Button(frame_new_my_diagnosis, text='Сохранить',
                                            ...
                                            font=('Comic Sans MS', user.get('text_size')))
        button_saved_new_diagnosis.pack(fill='both', expand=True)
        ...
        frame_my_saved_diagnosis_but.pack(fill='both', expand=True)
    ...
    def my_saved_diagnosis_change_status():
        ...
        if data['examination'].get('my_saved_diagnosis_status') == "closed":
            ...
            frame_my_saved_diagnosis.pack(fill='both', expand=True)
    ...
    frame_date_time = Frame(frame_1, borderwidth=1, relief="solid", bg="#36566d")
    ...
    button_change_all_kb_status = Button(frame_button, text='Скрыть\nвсе\nклавиатуры',
                                         ...
                                         font=('Comic Sans MS', user.get('text_size')))
    frame_diagnosis = Frame(examination_root, borderwidth=1, relief="solid", padx=3, pady=3)

    frame_my_saved_diagnosis_but = Frame(frame_diagnosis, borderwidth=1)
    frame_my_saved_diagnosis = Frame(frame_diagnosis, borderwidth=1, relief="solid", padx=3, pady=3)
    frame_new_my_diagnosis = Frame(frame_diagnosis, borderwidth=1, relief="solid", padx=3, pady=3)
        ...
        if complaints_button not in ('нет', 'обусловлены основным заболеванием'):
            if '_' in complaints_button:
                ...
                if data['examination']['complaints_but'].get(complaints_button).get() == 1:
                    ...
                    if local_complaints.get("add"):
                        for i in (f"{complaints_button}, ", f"{complaints_button},", f", {complaints_button}",
                                  f"{complaints_button}"):
    ...
    def paste_patient_anthro_data():
        ...
        frame_patient_anthro = Frame(frame_patient_anthro_main, borderwidth=0.5, relief="solid", padx=1, pady=1,
                                     bg="#36566d")
        ...
        for mark in local_data_anthro:
            ...
            for name, variable in local_data_anthro.get(mark):
                ...
                # if variable == 'txt_br_variable':
                #     data['examination']['anthro'][variable].set(render_data.get('br'))
                if variable == 'txt_temp_variable':
    ...
    def select_examination():
        ...
        if (data['examination']['examination_but'].get(examination_button).get() == 1
            ...
            text += '\n'
            if mark_1 in ('Глаза', 'Отоскопия', "Шепотная речь", "Тимпанометрия"):
            ...
            if mark_1 in ('Глаза', 'Отоскопия', "Шепотная речь", "Тимпанометрия"):
                loc_data = {
                    'Глаза': ("OD", "OS", "OU"),
                    'Отоскопия': ("AD", "AS", "AU"),
                    'Шепотная речь': ("AD", "AS", "AU"),
                    'Тимпанометрия': ("AD", "AS", "AU")
                }
    ...
    def edit_examination_kb_text():
        for button_name in data['examination'].get('examination_buttons'):
            text = f"{button_name}: "
            if button_name in ('Глаза', 'Отоскопия', "Шепотная речь", "Тимпанометрия"):
                loc_data = dict()
                for examination_but in data['examination'].get('examination_but'):
    ...
    def paste_examination_kb():
        ...
        for mark_ in local_examination:
            if isinstance(mark_, tuple):
                ...
                if mark_[0] in ('Глаза', 'Отоскопия', "Шепотная речь", "Тимпанометрия"):
                    loc_data = {
                        'Глаза': ("OD", "OS", "OU"),
                        'Отоскопия': ("AD", "AS", "AU"),
                    'Шепотная речь': ("AD", "AS", "AU"),
        ...
        for mark in local_examination:
            if isinstance(mark, tuple):
                ...
                if mark[0] in ('Глаза', 'Отоскопия', "Шепотная речь", "Тимпанометрия"):
                    loc_data = {
                        'Глаза': ("OD", "OS", "OU"),
                        'Отоскопия': ("AD", "AS", "AU"),
                    'Шепотная речь': ("AD", "AS", "AU"),
                    ...
                    for mark_3 in loc_data.get(mark[0], []):
                        ...
                        Label(master=frame_loc_but_side, text=f"{mark_3}",
                              font=('Comic Sans MS', user.get('text_size')),
                              bg='white').pack(fill='both', expand=True, padx=1, pady=1, anchor='w', side='left')
                        frame_string_main = Frame(frame_loc_but_side, borderwidth=1)

                        frame_string = Frame(frame_string_main)

                        for mark_2 in mark[1:]:
                            if mark_2 == '\n':
                                frame_string.pack(fill='both', expand=True)
                                frame_string = Frame(frame_string_main)

                            else:
                                btn = Radiobutton(frame_string, text=f"{mark_2}",
                                                  font=('Comic Sans MS', user.get('text_size')),
                                                  value=f"{mark[0]}_{mark_3}_{mark_2}",
                                                  variable=selected_button,
                                                  command=select_examination,
                                                  indicatoron=False, bg='#f0fffe', selectcolor='#77f1ff', padx=2)
                                btn.pack(fill='both', expand=True, padx=1, ipadx=3, side='left')
                                data['examination']['examination_buttons_2_color'][f"{mark[0]}_{mark_3}_{mark_2}"] = btn

                        else:
                            frame_string.pack(fill='both', expand=True)
                            frame_string_main.pack(fill='both', expand=True)
                    ...
                    for mark_2 in mark[1:]:
                        if mark_2 != '\n':
                            btn = Radiobutton(frame_loc_but_string, text=f"{mark_2}",
                                              ...
                                              command=select_examination,
                                              indicatoron=False, bg='#f0fffe', selectcolor='#77f1ff')
                            btn.pack(fill='both', expand=True, side='left', ipadx=3)
    ...
    txt_examination = ScrolledText(frame_examination_main, width=50, height=30,
                                   font=('Comic Sans MS', user.get('text_size')),
                                   wrap="word")
        ...
        def select_button_risk():
            ...
            if patient_age.get('year') == 0:
                ...
                for mark, old_string, new_string in (("На основании групп риска:", edited_string_risk, new_string_risk),
                                                     ("На основании диспансеризации:", edited_string_disp,
                                                      new_string_disp)):
                    if not old_string:
                        if new_string:
                            text += f"\n{mark} {new_string}"
    ...
    def create_consultation_root():
        cons_doc = (
                    "оториноларинголога УЗ 3-я ГДКБ",
                    "оториноларинголога РНПЦ ЛОР",
                    "R-грамма ППН",
    ...
    def write_ln():
        ...
        def save():
            ...
            if check_input():
                ...
                txt_ln_from.insert(0,
                                   data['examination']['LN_data']['current_data'].get("Дата начала ВН").get().strip())
    ...
    if not patient.get('name'):
        ...
        def create_type_cert_frames():
            ...
            def create_certificate():
                def certificate__create_doc():
                    ...
                    if (type_certificate == "Оформление в ДДУ / СШ / ВУЗ"
                        ...
                        elif type_certificate in (
                                'Годовой медосмотр', 'В детский лагерь', "Оформление в ДДУ / СШ / ВУЗ"):
                            render_data['manager'] = '______________________'
                            if type_certificate.startswith('Оформление в ДДУ / СШ / ВУЗ'):
                                render_data['manager'] = user.get('manager', '______________________')

                            doc_name = f".{os.sep}generated{os.sep}{patient.get('name').split()[0]}_" \
                                       f"справка_{type_certificate}.docx".replace(' в ДДУ / СШ / ВУЗ', '').replace(' ',
                                                                                                                   '_')
                ...
                try:
                    ...
                    if type_certificate == 'Оформление в ДДУ / СШ / ВУЗ':
                        ...
                        if place_of_requirement == 'ВУЗ (колледж)':
                            ...
                            render_data[
                                'additional_medical_information'] = "_____________________________________________"
                    ...
                    if type_certificate == 'О нуждаемости в сан-кур лечении':
                        render_data[
                            'diagnosis'] = f"Имеются медицинские показания и отсутствуют медицинские противопоказания " \
                    ...
                    if type_certificate == 'ЦКРОиР':
                        ...
                        result = data['certificate']['type_cert_info'][type_certificate]['ЦКРОиР_add_med_info'].get(1.0,
                                                                                                                    'end').strip()
                        for doctors in ('Невролог', 'Офтальмолог', 'ЛОР', 'Логопед'):
                            result += f"\n{doctors}: " \
                    ...
                    data['certificate']['type_cert_frames']['selected_cert'].pack(fill='both', expand=True, padx=2,
            ...
            for type_certificate in all_data_certificate.get('type'):
                ...
                if type_certificate in (
                        'Годовой медосмотр', 'Оформление в ДДУ / СШ / ВУЗ', 'В детский лагерь',
                        'Об усыновлении (удочерении)',
                        'Об отсутствии контактов', 'Бесплатное питание', 'О нуждаемости в сан-кур лечении'):
                ...
                if type_certificate == 'ЦКРОиР':
                    def set_default():
                        ...
                        diagnosis.delete(1.0, 'end')
                        diagnosis.insert(1.0, all_data_certificate['all_info']['ЦКРОиР'].get(
                    ...
                    diagnosis = ScrolledText(frame, width=80, height=8,
                                             font=('Comic Sans MS', user.get('text_size')), wrap="word")
                    diagnosis.pack(fill='both', expand=True)
                    diagnosis.insert(1.0,
                                     all_data_certificate['all_info']['ЦКРОиР'].get('additional_medical_information'))
                    ...
                    for doctors, diagnosis in (('Невролог', 'Без очаговой патологии'),
                        ...
                        Entry(frame, width=50,
                              textvariable=data['certificate']['type_cert_info'][type_certificate].get(
                                  f"{doctors}_txt"),
                              font=('Comic Sans MS', user.get('text_size'))
                              ).pack(fill='both', expand=True, side='left')
                        frame.pack(fill='both', expand=True, padx=2, pady=2)
    ...
    def create_blanks():
        ...
        if blank_name.get() == "Титульник":
            ...
            with sq.connect(f".{os.sep}data_base{os.sep}patient_data_base.db") as conn:
                cur = conn.cursor()
                cur.execute(
                    f"SELECT Домашний_телефон FROM patient_data WHERE amb_cart LIKE '{patient.get('amb_cart')}'")
        ...
        def create_selection():
            ...
            while date_start_selection != date_stop_selection:
                date_start_selection = (
                        datetime.strptime(date_start_selection, "%d.%m.%Y") + timedelta(days=1)).strftime(
                    "%d.%m.%Y")
                        ...
                        if len(patient_info_day) == 5:
                            ...
                            if not data['last_examination']['selection'][date].get(patient_info):
                                ...
                                data['last_examination']['selection'][date][patient_info][
                                    'button_patient'] = StringVar()
                                Radiobutton(
                                    frame_patient,
                                    textvariable=data['last_examination']['selection'][date][patient_info].get(
                                        'button_patient'),
                                    font=('Comic Sans MS', user.get('text_size')),
                                ...
                                if marker:
                                    if len(data['last_examination']['selection'][date][patient_info][
                                               'button_patient'].get().split('\n')[-1]) > 150:
                                        data['last_examination']['selection'][date][patient_info]['button_patient'].set(
                                            data['last_examination']['selection'][date][patient_info][
                                                'button_patient'].get() + "\n")
                                    data['last_examination']['selection'][date][patient_info]['button_patient'].set(
...
def main_root():
    ...
    def paste_frame_main():
        ...
        сalendar_img = ImageTk.PhotoImage(
            Image.open('сalendar_img.png').resize((user.get('text_size') * 2, user.get('text_size') * 2)))
